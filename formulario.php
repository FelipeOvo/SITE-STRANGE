...
<body>
	...
	<header>
      <nav class="navbar navbar-expand-lg navbar navbar-dark bg-dark">
        <a class="navbar-brand" href="./Home.html"><img src="./StrangeIcon.png" height="50" width="50"  class="d-inline-block align-top" alt=""></a>
	...
	<h1 align="center">Fale Conosco - <small>Deixe um comentário, elogio ou reclamação!</small></h1>
